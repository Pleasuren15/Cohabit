    ...
    (
        ...
        return (
            ...
            >
                <div
                    className={cn(
                        "glass-dock relative flex gap-4 items-center px-4 py-3 rounded-2xl",
                        "bg-background/80 backdrop-blur-xl glass-border shadow-2xl justify-center",
                        dockClassName
                    )}
                    onMouseLeave={() => {
                ...
                >
                    ...
                    {items.map((el, index) => {
                        ...
                        const isAnimated = ['blog', 'marker', 'email', 'linkedin', 'x', 'github'].includes(type);
